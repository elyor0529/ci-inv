...
<form class="navbar-form" role="search" action="" method="post" style="float: right; margin-top: -50px;">
    <div class="input-group">
        ...
        <div class="input-group-btn" style="margin-top:30px;">
            <button class="btn btn-default " name="search" type="submit" value="Search"
                    style="margin-top:-1px !important;"><i class="glyphicon glyphicon-search"></i></button>
        </div>
    </div>
            ...
            <tr>
                <td>
                    <a href="<?php echo $img; ?>" target="_blank">
                        <image width="80" height="60" src="<?php echo $img; ?>"/>
                    </a>
                </td>
                <td>
