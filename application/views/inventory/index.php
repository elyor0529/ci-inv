...
<form class="navbar-form" role="form" action="<?php echo base_url(). 'inventory/search'?>" method="get" style="float: right; margin-top: -50px;">
    <div class="input-group">
        <input type="text" class="form-control" placeholder="Search" naem="search" size="15px; ">
        <div class="input-group-btn actions" style="margin-top:30px;">
            <button class="btn btn-default " name="submit" type="submit" value="Search" style="margin-top:-1px !important;"><i class="glyphicon glyphicon-search"></i></button>
        </div>
    </div>
